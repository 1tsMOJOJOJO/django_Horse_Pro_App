...
class Show(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('horse_show.views.update', args=[str(self.id)])

    def get_read_url(self):
        return reverse('horse_show.views.read', args=[str(self.id)])
...
class Rider(models.Model):
    ...
    HighpointTeam = models.ForeignKey('HighpointTeam', on_delete=models.CASCADE)
    Division = Division = models.ForeignKey('Division', on_delete=models.CASCADE)
...
class Number(models.Model):
    ...
    HighpointDivision = models.ForeignKey('Seat', on_delete=models.CASCADE)
    def __unicode__(self):
...
class ShowClassSchedule(models.Model):
    ShowClass = models.ForeignKey('ShowClass', on_delete=models.CASCADE)
...
class Judging(models.Model):
    ...
    SeatRidden = models.ForeignKey('Seat', on_delete=models.CASCADE)
    Place = models.ForeignKey('HighpointPlacing', on_delete=models.CASCADE)
    #Place = models.IntegerField(help_text="What place did the rider recieve")
    Judge =  models.ForeignKey('Judge', on_delete=models.CASCADE, help_text="Who was the judge for this judging")

    Danish = models.ForeignKey('Danish', on_delete=models.CASCADE, help_text="What danish did the rider recieve", default=None, null=True, blank=True)
...
class ClassEntry(models.Model):
    ...
    ShowClass =  models.ForeignKey('ShowClass', on_delete=models.CASCADE)
    EntryType =  models.ForeignKey('EntryType', on_delete=models.CASCADE, blank=True, null=True, editable=False)
...
class FeedBackResponse(models.Model):
    ...
    FeedBackQuestion =  models.ForeignKey('FeedBackQuestion', on_delete=models.CASCADE)
